...
public class StoreCustomerInsideAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView=layoutInflater.inflate(R.layout.item_customer_inside,null);
            ...
            viewHolder.tv_people=convertView.findViewById(R.id.tv_people);
            convertView.setTag(viewHolder);
        }else {
            viewHolder= (ViewHolder) convertView.getTag();
        }
        viewHolder.tv_date.setText(list.get(position));
        viewHolder.tv_way.setText(list.get(position));
        viewHolder.tv_phone.setText(list.get(position));
        viewHolder.tv_people.setText(list.get(position));
